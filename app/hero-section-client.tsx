...
export default function HeroSectionClient() {
  ...
  return (
    <section className="flex flex-col font-inter justify-center items-center text-center mt-24 sm:mt-32 md:mt-44 px-4 sm:px-6 md:px-12">
      <motion.div
        className="flex font-poppins flex-col items-center text-[white] sm:items-start text-4xl sm:text-5xl md:text-7xl font-bold leading-snug sm:leading-tight"

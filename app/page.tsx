    ...
    <div className="relative min-h-screen bg-[#090a15] text-white font-inter overflow-hidden">
      ...
      <div className="relative z-10 max-w-[90%] mx-auto">
        ...
        <section className="px-4 sm:px-6 md:px-12 pb-16 sm:pb-20 md:pb-24 mt-16 sm:mt-20">
          <motion.div
            className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 items-stretch"
            initial="hidden"
            whileInView="visible"
            viewport={{ once: true }}
            variants={{
          ...
          >
            {features.map((feature, i) => (
              <motion.div
                ...
                className="h-full bg-[#090a15b0] border border-white/10 rounded-2xl
        p-5 sm:p-6 text-white/80
        hover:bg-[#141520b0]
        transition-colors duration-300
        flex"
              >
                <div className="flex gap-4 flex-col sm:flex-row h-full">
                  {/* Icon */}
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-center">
            ...
            <div className="md:order-1">
              ...
              <p className="text-white/70 text-sm sm:text-lg leading-relaxed">
                ...
                projects, find serious collaborators, and keep working together
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12 items-center">
            ...
            <div className="md:order-2">
              ...
              <p className="text-white/70 text-sm sm:text-lg leading-relaxed">
                Every interaction on Togethr contributes to trust. From accepted
                requests to completed collaborations, trust scores help you
                identify reliable builders — not just loud profiles.
              </p>
            </div>
          </div>
        </section>
